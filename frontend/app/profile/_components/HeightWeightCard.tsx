...
export default function HeightWeightCard({
    ...
    return (
        <div
            className="flex w-full max-w-[18vw] aspect-[334/196] flex-col items-center justify-center rounded-[20px] border border-[#0A3323] bg-[#FFFDEE] shadow-[0_4px_4px_0_#0A3323]"
        >
            {/* Icon + text */}
