    ...
    <section className="w-full max-w-4xl py-1">
      <header className="space-y-4">
        ...
        <div className="[font-family:var(--font-home-title)]" style={{ color: "rgba(38, 97, 47, 1)" }}>
          ...
          <h1 className="mt-1 w-full max-w-84 text-[48px] font-medium leading-[0.92] tracking-[-0.06em] md:whitespace-nowrap lg:max-w-none lg:text-[5.1rem] lg:leading-[0.95] lg:tracking-tight">
      ...
      <div className="mt-8 flex max-w-lg items-center gap-4 lg:mt-10 lg:gap-5">
        ...
        <p className="text-[1rem] text-accent-warm">or continue with</p>
        <span className="h-px flex-1 bg-border-subtle/70" />
      </div>

      <button
        type="button"
        className="mt-3 inline-flex h-12 w-full max-w-lg items-center justify-center gap-3 rounded-xl border border-zinc-300 bg-white px-5 text-[1.25rem] font-medium text-zinc-600 shadow-sm transition hover:bg-zinc-50 lg:w-auto lg:min-w-[16rem]"
      >
